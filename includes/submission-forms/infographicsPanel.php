    ...
    <form name="infographic-form">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-sm-12 py-2">
                <input type="date" class="form-control" name="publication_date" id="info-publication-date" max="<?= date('Y-m-d') ?>" required>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col">
                <input type="submit" class="btn btn-primary button-submit-research rounded-0 my-3" value="Upload to Repository" id="submitInfographicsButton" <?php if (!in_array($_SESSION['userType'] ?? '', array('admin', 'super_admin'))) {
                                                                                                                                                                    echo 'disabled';
                                                                                                                                                                } ?>>
            </div>
        </div>
