...
<div class="<?php if (in_array($_SESSION['userType'] ?? '', array('admin', 'super_admin'))) {
    ...
    <form name="thesis-form">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-sm-12 mb-3">
                <input type="date" class="form-control" name="publication_date" id="publication-date" max="<?= date('Y-m-d') ?>" required>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-6 col-sm-12 d-none d-lg-block">
        ...
        <div class="row">
            <div class="col">
                <input type="submit" class="btn btn-primary button-submit-research rounded-0 my-3" id="submitResearchDissertationButton" <?php if (!in_array($_SESSION['userType'] ?? '', array('admin', 'super_admin'))) {echo 'disabled value="Submit your research"';} else {
