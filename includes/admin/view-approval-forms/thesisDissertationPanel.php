        ...
        $("form[name='thesis-form']").on("submit", function(event) {
            ...
            $.ajax({
                ...
                if (data.response === "revision") {
                    $("#alert-container-thesis").html(`<div class="alert alert-success alert-dismissible fade show" role="alert"><strong>Submission returned successfully!</strong><button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>`);
                }
            })
        })
    </script> -->
