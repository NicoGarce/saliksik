    ...
    <div class="col-lg-10 px-5 col-md-12 col-xs-12 main-column" id="thesisDissertationPanel">
        ...
        <form name="thesis-form" action="<?php echo "../../src/process/update-file.php?id=".$fileInfo['file_id']."&coauthor_id=".$fileInfo['coauthor_group_id']; ?>" method="POST">
            ...
            <div class="row my-4">
                ...
                <div class="col">
                    <label class="my-2"><a href="../../src/<?php echo $fileInfo['file_dir'];?>" target="_blank"><?php echo $fileInfo['file_name'];?></a></label>
                    ...
                    <label class="my-2"><a href="../../src/<?php echo $fileInfo['file_dir2'];?>" target="_blank"><?php echo $fileInfo['file_name2'];?></a></label>
                    <div class="form-check form-switch">
