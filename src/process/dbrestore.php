...
define("DB_USER", 'root');
define("DB_PASSWORD", '');
define("DB_NAME", 'saliksik');
define("DB_HOST", 'localhost');
define("BACKUP_DIR", 'db-backup'); // Comment this line to use same script's directory ('.')
define("BACKUP_FILE", 'myphp-backup-saliksik.sql'); // Script will autodetect if backup file is gzipped based on .gz extension
define("CHARSET", 'utf8');
