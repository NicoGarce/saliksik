...
if (isset(
    ...
    if (empty($_POST['textFieldFirstName'] && $_POST['textFieldLastName'] && $_POST['textFieldEmail'] && $_POST['dropdownDepartment'] && $_POST['textFieldPassword'] && $_POST['textFieldPasswordConfirm'])) {
