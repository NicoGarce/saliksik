        ...
        if ($result['file_type'] === 'thesis') {
            ...
            if(strlen($result['research_abstract'])>500){
                // truncate string
                 ...
                 $result['research_abstract'] .= "... <a href='". base_url() . "/repository/view-article.php?id={$result['file_id']}' target='_blank' class='read-more'>Read More</a>";
            ...
            if(strlen($result['journal_description'])>500){
                // truncate string
                 ...
                 $result['journal_description'] .= "... <a href='". base_url() . "/repository/view-article.php?id={$result['file_id']}' target='_blank' class='read-more'>Read More</a>";
            ...
            if(strlen($result['infographic_description'])>500){
                // truncate string
                 ...
                 $result['infographic_description'] .= "... <a href='". base_url() . "/repository/view-article.php?id={$result['file_id']}' target='_blank' class='read-more'>Read More</a>";
