...
<head>
    ...
    <title>View Document | SALIKSIK</title>
                ...
                <div class="col">
                    <div class="text-start">
                        <button class="btn btn-link page-control">
                            ...
                            <?php
                            echo '<a href="view-article.php?id=' . $_SESSION['fileId'] . '" class="page-control"><i class="fas fa-arrow-left" style="color: #012265;"></i> Back</a>';
