...
<head>
    ...
    <title>My Library | SALIKSIK</title>
...
<body class="d-flex flex-column min-vh-100">
    ...
    <section class="admin-masthead">
        <div class="container">
            <h1>My Library</h1>
            <p class="masthead-subtitle">Access your bookmarked research materials</p>
        </div>
    </section>
                ...
                <div class="col-lg-11">
                    <div class="admin-panel">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <div class="admin-panel-title mb-0" style="border-bottom:none;padding-bottom:0;">Saved Items</div>
                            <div style="width:200px;">
                                <select class="form-select admin-select" id="submission-type-dropdown">
